...
require(gridExtra)
require(lattice)
grid.arrange(dotplot(ranef(glm.mod, condVar = TRUE))[[1]],
             dotplot(ranef(glm.mod, condVar = TRUE))[[7]],
             ncol = 2)
@
\caption{TODO}
\label{someoutput}
